...
class Database:
  ...
  def get_user(self, id):
    sql = "SELECT userID,name,email,password FROM Users WHERE UserID=%s;"
  ...
  def add_user(self, user):
    sql = "INSERT INTO Users (userID, name, email, password) VALUES (%s, %s, %s, %s);"
  ...
  def add_submission(self, sub):
    sql = "INSERT INTO Submissions (submissionID, userID, name, result, error) VALUES (%s, %s, %s, %s, %s);"
  ...
  def update_submission(self, sub):
    sql = "UPDATE Submissions SET userID=%s, name=%s, result=%s, error=%s WHERE submissionID=%s;"
  ...
  def get_submissions(self, userID):
    sql = "SELECT submissionID, userID, name, result, error, submitTime FROM Submissions WHERE userID=%s;"
    cursor = self.db.cursor()
